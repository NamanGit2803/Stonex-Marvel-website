        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="hidden lg:flex flex-col items-center justify-center w-full">
            ...
            >
              ...
              <span className="font-semibold text-xl tracking-wide">House of Indian Stonex</span>
            </Link>
          ...
          <div className={cn(
            ...
            <div className="p-6 min-h-full">
              ...
              <div className="flex items-center justify-center gap-3 mb-8">
                ...
                <span className="font-semibold text-lg tracking-wide">House of Indian Stonex</span>
              </div>
