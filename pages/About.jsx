  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 px-6 pb-12">
      <section className="max-w-6xl mx-auto grid grid-cols-1 gap-10 items-center">
        {/* Illustration/Hero */}
        <div className="bg-[#fff7f2] w-full p-5 grid grid-cols-6 min-h-[50vh] rounded-2xl border border-orange-100">
          <div className="h-full w-full flex justify-center items-center flex-col col-span-2 text-center sm:text-left">
            <div className="space-y-1">
              ...
              <h3 className="text-4xl sm:text-5xl font-bold text-[#ff7e2e]">Indian</h3>
              <h3 className="text-5xl sm:text-6xl font-extrabold">Stonex</h3>
              <p className="text-gray-700 mt-2 max-w-[28ch] text-sm">
                Crafting marble temples, sculptures, and bespoke stonework with timeless artistry.
              </p>
              <div className="mt-4 flex items-center gap-3">
                <a
                  href="#contact"
                  className="inline-flex items-center bg-[#ff7e2e] text-white px-4 py-2.5 rounded-lg font-medium hover:opacity-95"
                >
                  Get a Quote
                </a>
                <a
                  href="#gallery"
                  className="inline-flex items-center border border-[#ff7e2e]/30 text-[#ff7e2e] px-4 py-2.5 rounded-lg font-medium bg-white hover:bg-[#ff7e2e]/10"
                >
                  View Gallery
                </a>
              </div>
        ...
        <div id="about" className="space-y-6">
          ...
          <section aria-label="Key highlights" className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="rounded-xl border border-gray-100 p-4 bg-white text-center">
              <p className="text-3xl font-extrabold text-[#ff7e2e]">25+</p>
              <p className="text-xs text-gray-600 mt-1">Years Experience</p>
            </div>
            <div className="rounded-xl border border-gray-100 p-4 bg-white text-center">
              <p className="text-3xl font-extrabold text-[#ff7e2e]">1200+</p>
              <p className="text-xs text-gray-600 mt-1">Projects Delivered</p>
            </div>
            <div className="rounded-xl border border-gray-100 p-4 bg-white text-center">
              <p className="text-3xl font-extrabold text-[#ff7e2e]">18</p>
              <p className="text-xs text-gray-600 mt-1">Countries Served</p>
            </div>
            <div className="rounded-xl border border-gray-100 p-4 bg-white text-center">
              <p className="text-3xl font-extrabold text-[#ff7e2e]">100%</p>
          ...
          <div id="services" className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <article id="why" className="p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
          ...
          <section id="gallery" aria-label="Selected works gallery" className="pt-4">
